...
import info.esblurock.reaction.chemconnect.core.base.client.catalog.record.StandardDatasetRecord;
...
public class StandardDatasetObjectHierarchyItem extends Composite 
	...
	public void writeDatabaseObjectHierarchy() {
		...
		WriteHierarchyToDatabase.writeDatabaseObjectHierarchy(hierarchy);
	}

	public void writeYamlObjectHierarchy() {
		updateDatabaseObjectHierarchy();
		WriteHierarchyToDatabase.writeYamlObjectHierarchy(hierarchy);
	}
