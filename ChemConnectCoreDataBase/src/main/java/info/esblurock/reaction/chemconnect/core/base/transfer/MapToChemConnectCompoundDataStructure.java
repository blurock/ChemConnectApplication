...
public class MapToChemConnectCompoundDataStructure implements Serializable {
	...
	Map<String, CompoundDataStructure> map;
	
	public MapToChemConnectCompoundDataStructure() {
		map = new HashMap<String, CompoundDataStructure>();
	}
	
	public void addStructure(CompoundDataStructure structure) {
		map.put(structure.getRecordType(), structure);
	}
	
	public CompoundDataStructure getStructure(String structureName) {
