...
import info.esblurock.reaction.chemconnect.core.common.expdata.async.ObservationServicesAsync;
...
public class IsolateMatrixBlock extends Composite implements IsolateMatrixBlockView, ObjectVisualizationInterface {
	...
	public void createCatalogObject(DatabaseObject obj,DataCatalogID datid) {
		SetUpDatabaseObjectHierarchyCallback callback = new SetUpDatabaseObjectHierarchyCallback(contentcollapsible,modalpanel,true);
		ObservationServicesAsync async = ObservationServices.Util.getInstance();
