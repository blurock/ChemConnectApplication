...
public class ChemConnectCompoundBase extends ChemConnectCompoundDataStructure {


   public ChemConnectCompoundBase() {
   }

   public ChemConnectCompoundBase(ChemConnectCompoundDataStructure structure) {
      super(structure);
   }
