...
public class ChemConnectStructureUser extends ChemConnectStructureBase {


   public ChemConnectStructureUser() {
   }

   public ChemConnectStructureUser(ChemConnectStructureBase structure) {
      super(structure);
   }
