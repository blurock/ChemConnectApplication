...
import info.esblurock.reaction.chemconnect.data.TransactionEvent;

@Entity
@SuppressWarnings("serial")
public class TransactionBase extends TransactionEvent {


   public TransactionBase() {
   }

   public TransactionBase(TransactionEvent structure) {
      super(structure);
   }
