...
public class InitialReadInOfRepositoryFile extends RepositoryFile {


   public InitialReadInOfRepositoryFile() {
   }

   public InitialReadInOfRepositoryFile(RepositoryFile structure) {
      super(structure);
   }
