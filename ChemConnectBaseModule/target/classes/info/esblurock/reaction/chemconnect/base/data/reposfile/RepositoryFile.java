...
import info.esblurock.reaction.chemconnect.base.data.TransactionBase;

@Entity
@SuppressWarnings("serial")
public class RepositoryFile extends TransactionBase {


   public RepositoryFile() {
   }

   public RepositoryFile(TransactionBase structure) {
      super(structure);
   }
