...
public class InitialReadFromWebLocation extends InitialReadInOfRepositoryFile {


   public InitialReadFromWebLocation() {
   }

   public InitialReadFromWebLocation(InitialReadInOfRepositoryFile structure) {
      super(structure);
   }
